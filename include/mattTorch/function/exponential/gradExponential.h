...
public:
// Create a GradExponential object with a vector containing the tensors that were
// used to create it, as well as vector of their GradFunction objects. These are
// used for calculation of the gradient and passing it further up the computation
// graph
